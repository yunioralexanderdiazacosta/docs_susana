...
<script>
    ...
    function format (data) {
        var views = '';
        data.filter(element => {
            views += `<tr><th>Project Name</td><td>${element.project}</td><th>Language</th><td>${element.language}<td></tr>`;
        }) 
        return '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;">'+views+'</table>';
    }
